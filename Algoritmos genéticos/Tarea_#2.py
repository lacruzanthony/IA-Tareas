...
def multipleGeneration(number_of_generation, password, size_population, best_sample, lucky_few, number_of_child, chance_of_mutation, chance_of_replicate):
	historic = []
...
#variables
password = "banana"         # Tablero de juego.

best_sample = 20            # Las mejores 20 jugadas.
lucky_few = 20              # Ramdom 20 veces para escoger las peores 20 jugadas.

size_population = 1000
number_of_generation = 500
number_of_child = 15
chance_of_replicate = 10
...
if ((best_sample + lucky_few) / 2 * number_of_child != size_population):
	...
	historic = multipleGeneration(number_of_generation, password, size_population, best_sample, lucky_few, number_of_child, chance_of_mutation, chance_of_replicate)
